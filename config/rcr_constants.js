const RCR_CONSTANTS = {
    ...
    --files '<files array>' --instance <name>      
                       >> to perform code review on file Ids 
                       ex: crnow --file '[{“sys_id”:fa919f87c3007236d9f0zwfe961914, “type”:”sys_script”}]'

    --updateset <id> --instance <name>
                       >> to perform code review on update set files 

    --scopedapp <id> --instance <name>
                       >> to perform code review on scoped app files

    --duration <days> --instance <name>  
                       >> to perform code review script files which are modified in last delta days
